...
// No 1
console.log(
  "The quote 'There is no exercise better for the heart than reaching down and lifting people up.'by John Holmes teaches us to help another"
);
// No 2
console.log(
...
let num = "10";
typeof num === Number
  ? console.log("it is  not exactly the same")
  : console.log(`It is now exactly the same now : ${parseInt(num)}`);
// No 4
...
// No 8
console.log(Math.floor(Math.random() * 41) + 60); // Math.floor(Math.random() * ((max-min) + 1)  min);
// No 9
...
// No 12
console.log(phraseSentence.substr(30, 24));
// EXERCISE LEVEL 3
//  No 1
console.log(
...
console.log(money1, money2, money3);
const totalIncome =
  parseInt(money1) * 12 + parseInt(money2) + parseInt(money3) * 12;
