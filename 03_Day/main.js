...
isStealing = false
isStealing ?
console.log('Is a good act') :
 console.log('Is not a good act')
//  No 5
console.log(4 > 3);
console.log(4 >= 3);
console.log(4 < 3);
...
if ((2020 - yearBorn) >= 18) {
    console.log(`Enter birth year: ${yearBorn}\nYou are ${2020 - Number(yearBorn)}. You are old enough to drive`)
} else {
    console.log(`Enter your birth: ${yearBorn}\nYou are ${2020 - yearBorn}. You will be allowed to drive after ${2023 - 2020} years`)
}
// No 14
let userNumberOfYears =  prompt('Enter number of years')
console.log(`Enter number of yours you live: ${userNumberOfYears}\nYou lived ${new Date().getSeconds * userNumberOfYears}`)
// No 15
...
console.log(`${YY}-0${MM}-0${DD} ${HH}:${mm}`)
